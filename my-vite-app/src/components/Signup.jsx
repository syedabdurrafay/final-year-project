    ...
    <div className="ci-signup-container">
      ...
      <div className="ci-signup-card">
        ...
        <div className="ci-biometric-prompt">
          ...
          <p>Identity verification available</p>
        </div>

        <h2 className="ci-signup-title">
          <span className="ci-title-glow">Registration Portal</span>
        </h2>
        <p className="ci-signup-subtitle">Join the neural network collective</p>
          ...
          <div className="ci-signup-options">
            <div className="ci-cyber-checkbox">
              <input
                ...
                disabled={isLoading}
              />
              <label htmlFor="terms" className="ci-cyber-check">
      ...
      <div className="ci-cyber-console">
        <div className="ci-console-text">
          {isLoading ? 'Creating account...' : 'System secure. Identity verification active. Ready for registration.'}
        </div>
